...
class _LoginPageAccesibleState extends ConsumerState<LoginPageAccesible> {
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        _campoActual == 2 ? Colors.greenAccent : Colors.green,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
            ...
            child: _botonGrande(
              ...
              () async {
                if (_campoActual <= 1) {
                  ...
                  if (!_escuchando) {
                    ...
                    if (texto.isNotEmpty) {
                      ...
                      if (_campoActual == 1) {
                        ...
                        print(
                          'LOG INPUT: Contraseña ingresada: "$textoLimpio"',
                        );
                      }
                  ...
                  // Botón OK (Ingresar)
                  print(
                    'LOG AUTH: Intentando login con Usuario: ${login.username} | Contraseña: ${login.password}',
                  );
                  tts.hablar("Ingresando...");
          ...
          Expanded(
            child: _botonGrande("Elim", Icons.delete, () {
              if (_campoActual == 0) {
  ...
  void _ttsCampoActual() {
    if (_campoActual == 0)
      tts.hablar("Campo usuario");
    else if (_campoActual == 1)
      tts.hablar("Campo contraseña");
    else
      tts.hablar("Botón ingresar");
  }
